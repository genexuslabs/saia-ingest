...
Initial https://github.com/run-llama/llama-hub/blob/main/llama_hub/google_drive/base.py
"""
...
class GoogleDriveReader(BaseReader):
    ...
    def get_files(self, folder_id: str, mime_types: list = None) -> [str]:
